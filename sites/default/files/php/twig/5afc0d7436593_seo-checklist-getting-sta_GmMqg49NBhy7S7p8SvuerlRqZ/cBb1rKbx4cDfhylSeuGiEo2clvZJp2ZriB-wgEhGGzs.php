...
<p>This checklist is a guide to technical SEO but it doesn't help you with content optimization, keyword research, marketing strategy, etc. If you need help with these things, consider using a Drupal-specific Internet Marketing consultant like <a href=\"http://www.volacci.com/contact?";
        // line 20
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["ga_query_string"]) ? $context["ga_query_string"] : null), "html", null, true));
...
";
    ...
    {
        return new Twig_Source("", "modules/seo_checklist/templates/seo-checklist-getting-started.html.twig", "/home2/icomdev/public_html/modules/seo_checklist/templates/seo-checklist-getting-started.html.twig");
    }
}
